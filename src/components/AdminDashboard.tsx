...
// Generate PDF report for Paid and Unpaid student (2 pages, real data)
 ...
 function renderTableRows(studentList,sectionTitle) {
 // Table headers
 const col1 = margin;
 ...
 pdf.addPage();
 renderHeaderAndTitle(sectionTitle);
...
renderTableRows(paidStudent, 'Paid Student');

// Page 2: Unpaid Student
pdf.addPage();
renderHeaderAndTitle('Unpaid Student');
renderTableRows(unpaidStudent, 'Unpaid Student');
