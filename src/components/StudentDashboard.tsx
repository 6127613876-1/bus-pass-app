                      ...
                      <div className="mt-4 flex space-x-2">
                        <button
                          ...
                          onClick={async () => {
                            ...
                            // Adjusted Heading (split and shifted right)
                            pdf.setFont('helvetica', 'bold');
                            pdf.setFontSize(9);
                            pdf.text('THIAGARAJAR COLLEGE OF ENGINEERING', width / 2 + 12, margin + 10, { align: 'center' });
                            ...
                            pdf.setFontSize(7);
                            pdf.text('(Affiliated to Anna University)', width / 2 + 10, margin + 30, { align: 'center' });

                            // Student Details Section (middle-left)
                            let textY = 60;
                            pdf.setFontSize(7.5);
                              ...
                              try {
                                ...
                                await new Promise<void>((resolve, reject) => {
                                  reader.onloadend = () => {
                                    ...
                                    else reject(new Error("Photo reader result is null."));
                                  };
